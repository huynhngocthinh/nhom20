...
namespace WcfLapTopService
{
    ...
    public partial class LapTopEntities : DbContext
    {
        ...
        public virtual int TimKiemSP(Nullable<int> hang, Nullable<int> giaTu, Nullable<int> giaDen)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("TimKiemSP", hangParameter, giaTuParameter, giaDenParameter);
        }
    }
}
